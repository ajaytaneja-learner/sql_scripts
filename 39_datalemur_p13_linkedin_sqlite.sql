...
(
SELECT personal_profiles.profile_id AS profile_id, personal_profiles.name, personal_profiles.followers AS personal_followers,
personal_profiles.followers, personal_profiles.employer_id, company_pages.company_id, company_pages.name, company_pages.followers AS company_followers
